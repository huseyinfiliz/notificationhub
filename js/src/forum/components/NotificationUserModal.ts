                ...
                m('ul.NotificationGroup-content',
                    m('li',
                        m('a.Notification.Notification--customNotification', [
                            m('span.Avatar.Notification-avatar', { style: { '--avatar-bg': '#a4c0cd' } }, '#'),
                            ...
                            m('div.Notification-excerpt', this.selectedNotificationType  ?  this.notificationTypes?.find(type => type.id === this.selectedNotificationType)?.attributes.excerpt_key  : "" )
                        ])
                    )
                )
            ),
